...
**(Skripta)**:
Horizontalni tranzistory spatne v odvodu tepla a relativne velkemu odporu.
- LMOS (Lateral MOS) -> priklad horizontalniho MOS
- LDMOS (Lateral Double diffused MOS) -> zkracuje delku kanalu.
- VDMOS (Vertical Double diffused MOS) -> lepsi vykonova zpusobilost (stejne P, mensi S).
- VMOS (Vertically etched MOS) -> lepsi oxid-semiconductor region pro lepsi strmost charakteristiky
